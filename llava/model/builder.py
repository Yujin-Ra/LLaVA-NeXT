    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                ...
                if "mom" in model_name.lower():
                    from llava.model.language_model.llava_qwen_mom import LlavaQwenMomConfig
                    model = LlavaQwenMomForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, attn_implementation=attn_implementation, **kwargs)
                else:
